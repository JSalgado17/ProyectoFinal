...
function createPaypalTransacction( $_amount , $_items )
{
    ...
    //parametro
    $redirectUrls
        ->setReturnUrl("http://localhost/ProyectoFinal/SimplePHPMvcOPP-NW202103v2/index.php?page=checkoutapr")
        ->setCancelUrl("http://localhost/ProyectoFinal/SimplePHPMvcOPP-NW202103v2/index.php?page=checkoutcnl");
